...
class _Central(NSObject):
    ...
    def peripheral_didDiscoverCharacteristicsForService_error_(
        ...
        for ch in (service.characteristics() or []):
            ...
            if cuid.isEqual_(ff01_uuid):
                ...
                # Enable notifications. CoreBluetooth handles the CCCD write internally —
                # DO NOT manually write to the CCCD descriptor, that throws
                # NSInternalInconsistencyException ("Client Characteristic Configuration
                # descriptors must be configured using setNotifyValue:forCharacteristic:").
    ...
    def peripheral_didUpdateNotificationStateForCharacteristic_error_(
        ...
        """CoreBluetooth emits this when the OS-level subscribe completes."""
        if error:
